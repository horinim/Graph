...
#Инструкция
    def show_instructions():
        instructions = (
            ...
            "5. Граф будет отображен на экране.\n"
            "6. Если числа будут накладываться друг на друга,\nто вы можете нажать <<Расчитать максимальный поток>> повторно чтобы граф отобразился заново."
